...
function makepage(ob1)
 {
	...
	htmltemplate+='<div style="" class="lgin"><input type="text" name="username1" placeholder="Username"><input type="password" name="password1" placeholder="Password here"><button class="submit" value="login" id="login" name="login">Sign in</button></div></header>';
	...
	var img=ob1[m].image;
	var tags=JSON.stringify(ob1[m].tags);
	console.log('hello2');
	console.log(tags[0]);
	...
	htmltemplate+='<div style="margin-right:3px;display: inline-block;color:white;text-align: center;padding: 5px 10px;border: 1px solid;border-radius: 4px;font-size: 13px;">'+tags[m2]+'</div>'
	}
	htmltemplate+='</div></div></div><div class="arttit"><div class="artit">Its an article right now.</div><div class="artres"><div class="vm" style="padding-right: 15px;border-right: 1px solid #ccc;">';
	...
	htmltemplate+='<div style="text-align: center; margin-top: 5px;">24</div></div></div></div></div>';
	}	
	...
	htmltemplate+='<input style="padding: 6px;border: 1px solid;border-radius: 4px;margin: 10px;width: 250px;" type="text" name="username1" placeholder="Username"><input style="padding: 6px;border: 1px solid;border-radius: 4px;margin: 10px;width: 250px;" type="password" name="password1" placeholder="Password here"><div><button class="submit" value="login" id="login" name="login" style="padding: 6px;border: 1px solid;border-radius: 4px;margin: 10px;width: 250px;height: 45px;"><span style="font-size:18px">Register</span></button></div></div></div>';
	...
	htmltemplate+='</div></div><a class="twitter-timeline" data-width="365" data-height="600" data-theme="dark" href="https://twitter.com/sattyambhatt">Tweets by sattyambhatt</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></div></div></body></html>'
   return htmltemplate; 
}
//end here
///blog page
