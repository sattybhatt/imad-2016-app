...
function makepage(ob1,req){
	...
	htmltemplate+='<div id="gm" style="display: none;margin-left: 10%;font-size: 26px;color: white;font-weight: bold;font-style: oblique;font-family: Roboto, sans-serif;"></div>'
		 if(req.session && req.session.auth && req.session.auth.userid){
		htmltemplate+='<div id="gm" style="display: inline;margin-left: 10%;font-size: 26px;color: white;font-weight: bold;font-style: oblique;font-family: Roboto, sans-serif;">Good day '+req.session.auth.username2+'</div></header>';
