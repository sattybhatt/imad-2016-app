...
function makecontent(ob1){
    ...
    var template ='<!DOCTYPE html><html><head><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script><link href="https://fonts.googleapis.com/css?family=Lora|Open+Sans" rel="stylesheet"><link rel="stylesheet" type="text/css" src="blog3.css"><body>';
    template +='<header><div style="width:650px; margin:auto; position: relative; height: 60px;"><div class="incenter" style=""><div style="display: inline-block;vertical-align: middle; height: 27px;"><img src='++' style="height: 100%;"></div><div style="display: inline-block;vertical-align: middle;font-weight: bold;color: white;font-size: 28px;font-family: open sans;text-shadow: 0px 0px 5px #5a5a5a;"><span style="color: #e83751;">#</span><span style="color: #2f9bc7;">S</span></div>/div><div></div></div></header>';
	...
	{template +='<div style="margin-right:3px;display: inline-block;color:white;text-align: center;padding: 5px 12px;border: 1px solid;border-radius: 4px;font-size: 15px;font-family: open sans;">'+tags[m]+'</div>';}
