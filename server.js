...
function makecontent(ob1,req){
	...
	template +=z+'</div></div></div></div></div></div><div class="artmore"></div><div class="footer"></div></div><script src="/ui/main2.js"></script><script type="text/javascript" src="/ui/main.js"></script></body></html>';
	return template; 
}
//end here
