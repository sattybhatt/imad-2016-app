...
function makecontent(ob1){
	...
	var ob2="";
	var template="";
     template+='<!DOCTYPE html><html><head><script src="/ui/main2.js"></script><link rel="stylesheet" type="text/css" src="/ui/blog3.css"><body>';
	...
	template +=z+'</div></div></div></div></div></div><div class="artmore"></div><div class="footer"></div></div></body></html>';
	return template; 
}
//end here
