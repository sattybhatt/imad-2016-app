...
function makepage(ob1)
 ...
 htmltemplate += '<html><head><link href="/ui/blog1.css" rel="stylesheet" /><title>Blogs</title><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head><body><div style="width:100%;height:150px;">';
 htmltemplate +='<input type="text" placeholder="username" name="usrnm" id="usrnm"><input type="password" name="password" id="password"></div>';
