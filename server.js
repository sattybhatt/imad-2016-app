...
function makecontent(ob1){
	...
	var ob2="";
	var template="";
     template+='<!DOCTYPE html><html><head><link rel="shortcut icon" href="/ui/favicon.ico" type="image/x-icon"/ ><link rel="stylesheet" type="text/css" src="/ui/blog3.css"><body>';
